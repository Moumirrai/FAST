...
formy projektů
tradiční generální dodavatelství

ppp - public private partnership
- vyšší míra efektivnosti
- např nemocnice nebo sportoviště
- depo

###### Fidic
- smlouvy používané v ČR Anglii a Skandinávii, v Německu jiné
- švýcarská firma, vytvořeno inženýry protože se nelíbily stávající smlouvy.

Nechat subdodavatele, aby si nakoupil materiály, nepřeprodávat je, způsobuje to chaos a složitou logistiku.

Projektovali vězení v Bosně a Hercegovině, subdodavatel nemohl najít dveře do cel, tak je vymazal z výkazu a všimli si toho až dost pozdě.

Ve smlouvě dané kdo komu kůže dávat pokyny, a jak kdo volí technologické postupy.

###### Smlouva o dílo
- čas plnění
- cena díla
- vícepráce a dodatečné náklady

Pod máme ve smlouvě že dodatky musí být písemně, tak vždycky na tom trvat nebo to může být použito proti nám

**Proč být subdodavatelem**
- specializace
- nižší náklady
- jistá pravidelná práce
**Nevýhody**
- nižší zisk
- omezená kontrola
- konkurence

#### 28.11.2023 Thermoservis
- rodiná firma 30 let na trhu
- autodoprava
- zamní práce
- zakládání
- recyklace
...
- rozvoz zeminy
- hutnění
- stabilita stěn a výkopů

Výkup odpadů
- odpady se dočasně uskladňují na překladišti

cena za skládku se pohybuje za 150-1000 kč/t

RED Beton
- recyklovaný beton
- pevnostní třída až C25/30
...
Důležité pránovat v první fázy kdy se množntví nákladů dá ovlivnit, potom je to už téměř nemožné.

Velimi důležitá je frekventní a efektivní komunikace s investorem!

Na výběrové řízení se stejně jak jsme už slyšeli na předchozích přednáškách používají **FIDIC**y.
Ve výběrovém řízení soutěží všechny velikosti firem.
Nuto předem plánovat se zařízením staveniště.
Dostupnost zdrojů pro výstavbu, napčíklad voda pro mokré procesy. Pozitivní nebo negativní vliv ročního období a počasí.

V systému BIM možná lepší koordinace jenotlivých profesí.

**Dávat pozr na:**
- početní chyby
- podcenění náročnosti a času
- malá velikost týmu
- klimatické podmínky
- nedodržení nebo nepochopení požadavků
